    ...
    return (
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <AnimateIn>
            <div className="relative bg-gradient-to-br from-navy to-navy-dark rounded-3xl p-10 lg:p-14 border border-navy/20 overflow-hidden text-center">
              ...
              <a
                ...
                className="mt-8 inline-flex items-center gap-2 px-7 py-3.5 bg-teal hover:bg-teal-dark text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-teal/25 hover:shadow-teal/40 hover:-translate-y-0.5 cursor-pointer"
              >
    ...
    return (
      <div className="bg-gradient-to-br from-teal/5 to-teal/10 rounded-2xl p-6 border border-teal/20">
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div>
            <p className="text-sm font-bold text-navy-dark uppercase tracking-wider">
              Charter Program Open
            </p>
            <p className="mt-1 text-navy-dark">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-teal hover:bg-teal-dark text-white font-semibold text-sm rounded-xl transition-all duration-200 cursor-pointer"
          >
            Reserve a Spot &rarr;
          </a>
        </div>
  ...
  return (
    <section className="py-24 lg:py-32 bg-white">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        <AnimateIn>
          <div className="relative bg-gradient-to-br from-teal/5 to-teal/10 rounded-3xl p-10 lg:p-14 border border-teal/15 overflow-hidden">
            <div className="absolute top-0 right-0 w-80 h-80 bg-teal/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
            <div className="relative">
              <Badge variant="light">Atlantic Canada Charter Program</Badge>
              <h2 className="mt-6 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-navy-dark tracking-tight">
                ...
                <span className="text-teal">{CHARTER_DEADLINE}</span>.
              </h2>
              ...
              {/* Live spot counter */}
              <div className="mt-6 inline-flex items-center gap-3 bg-white/80 backdrop-blur rounded-xl px-5 py-3 border border-teal/20">
              ...
              <div className="mt-8 grid sm:grid-cols-3 gap-4">
                <div className="flex items-start gap-3 bg-white/60 rounded-xl p-4 border border-teal/10">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-10 inline-flex items-center gap-2 px-7 py-3.5 bg-teal hover:bg-teal-dark text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-teal/25 hover:shadow-teal/40 hover:-translate-y-0.5 cursor-pointer"
              >
