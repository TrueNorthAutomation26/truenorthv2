              ...
              <AnimateIn delay={0.45}>
                <div className="mt-10 flex flex-wrap gap-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2.5 px-7 py-4 bg-teal hover:bg-teal-dark text-white font-semibold rounded-xl transition-all duration-200 shadow-xl shadow-teal/25 hover:shadow-teal/40 hover:-translate-y-0.5 cursor-pointer"
                  >
        ...
        <div className="relative max-w-3xl mx-auto px-6 lg:px-8 text-center">
          ...
          <AnimateIn delay={0.2}>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-10 inline-flex items-center gap-2.5 px-9 py-4.5 bg-teal hover:bg-teal-dark text-white text-lg font-semibold rounded-xl transition-all duration-200 shadow-xl shadow-teal/25 hover:shadow-teal/40 hover:-translate-y-0.5 cursor-pointer"
            >
