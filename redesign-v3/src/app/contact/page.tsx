          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <AnimateIn>
                ...
                <h1 className="mt-6 text-5xl sm:text-6xl font-extrabold text-white tracking-tight">
                  The first step is a conversation.
                </h1>
              </AnimateIn>
              <AnimateIn delay={0.1}>
                <p className="mt-6 text-xl text-white/50 leading-relaxed max-w-md">
                ...
                <div className="mt-12 space-y-5">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="font-semibold">+1 (902) 316-0111</p>
                    </div>
                  </a>
              ...
              <AnimateIn delay={0.3}>
                <div className="mt-12 glass-card rounded-xl p-5 flex items-center gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-teal hover:bg-teal-dark text-white text-sm font-semibold rounded-lg transition-all duration-200 shadow-lg shadow-teal/20 hover:shadow-teal/30 hover:-translate-y-0.5 cursor-pointer whitespace-nowrap"
                  >
                    Book a Time
